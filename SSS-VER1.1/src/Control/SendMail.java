...
public class SendMail {
	...
	/**
	 * 给文件夹下目录的所有人， 发送邮件 send the email
	 * 
	 * @param type,this
	 *            week or last week
	 * @return
	...
	/**
	 * 在时间正确时，发送邮件 --- 每周最开始一分钟内 send the email, the first minute of this week
	 * 
	 * @param time
	 * @return
	 * @throws Exception
	...
	public static void deterSend(String time) throws Exception {
		...
		if (timeList[0].equals(sendTimeList[0])) {// 日期为一号
