...
public class StationB extends StationButton {
	public StationB(String name, Boolean borrow) {
		super(name, borrow);
	...
	/**
     * initiate the station B
     * @param 
     * @return
     * @throws  
     */
	public void Init() {//UserMain.mainFrame.dispose();
		boolean flag;
		try {
