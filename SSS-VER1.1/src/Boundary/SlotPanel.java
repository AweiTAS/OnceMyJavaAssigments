...
public class SlotPanel extends FrameInitiation {
	...
	/**
	 * build the page for user to choose scooter from each station @param
	 * station,row,type @return @throws
	 */
	public void createSlotPanel(int station, int row, boolean type) {
		...
		slotPanel.setLayout(new GridLayout(1, 8, 2, 2));
						...
						yesButton.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent e) {
								...
								// 还车
									...
									try {
										BackendLogic.returnS(date);// 查credit并存
